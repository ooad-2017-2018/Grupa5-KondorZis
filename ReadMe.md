...
Registracija potencijalnih kandidata:

        CiK dostavlja spisak kandidata za izbore koje administrator, pod nadzorom nadležnih osoba iz CiK-a unosi u sistem(Da bi se sprijecilo potencijalno izostavljanje ili dodavanje nekih od kandidata), nakon toga se generiše završni dll file koji ce se koristiti za vijeme izbora.
...
- Uvid u zauzetost glasacklih mjesta
